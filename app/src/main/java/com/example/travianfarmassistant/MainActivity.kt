...
class MainActivity : Activity() {
        ...
        val js = """
            (() => {
                ...
                for (const a of resourceAnchors) {
                    ...
                    resourceCandidates.push({fieldId, level, href:absoluteHref.href, disabled});
                }
    ...
    private fun handleVillageScanResult(rawJson: String) {
        ...
        if (minLevel < 10 && lowestResource != null && lowestResourceHref.isNotBlank() && lowestResourceLevel >= 0) {
